      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-4xl font-bold md:text-5xl">
            My creative nostalgia corner
          </h2>
          <p className="mt-4 text-lg text-ink/70">
            Three games I built from scratch, the way the old phones and arcade
            cabinets used to feel. Play them right here in the cards, or pop one
            out into a window you can drag anywhere on the page.
          </p>
        </div>
