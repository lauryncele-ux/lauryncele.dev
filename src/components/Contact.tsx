  ...
  return (
    <section id="contact" className="border-t-2 border-ink py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5">
        <div className="overflow-hidden rounded-[2rem] border-2 border-ink bg-coral text-cream shadow-punch">
          <div className="grid gap-8 p-8 md:grid-cols-[1.2fr_0.8fr] md:p-12">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex rounded-full border-2 border-cream bg-cream px-5 py-3 text-sm font-bold text-ink transition hover:-translate-y-1 hover:shadow-[6px_6px_0_0_rgba(255,255,255,0.35)]"
                >
                  Email me
                </a>
                <a
                  href={profile.cv}
                  download
                  className="inline-flex items-center gap-2 rounded-full border-2 border-cream px-5 py-3 text-sm font-bold text-cream transition hover:-translate-y-1"
                >
            ...
            <div className="space-y-4 rounded-3xl border-2 border-cream/30 bg-ink/10 p-6 backdrop-blur">
              <a
                href={`mailto:${profile.email}`}
